...
- [x] **演出ナシ**で、ボタン操作だけで大会を最初から最後まで完走できる
- [x] ブラケットが常に正しい（WB 勝者前進、LB 落とし、GF リセット）
- [x] 直前 1 手の **undo** が機能する
- [x] 操作端末 ↔ 表示端末が Realtime + DB で同期（リロード復元含む）
- [x] Vitest: 4/8/16 チーム、GF リセット、undo 再入力テスト PASS
